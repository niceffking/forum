...
public class SwaggerConfig {
    ...
    public Docket createApi() {
        Docket docket = new Docket(DocumentationType.OAS_30)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.example.forumspringboot27.controller"))
    ...
    private ApiInfo apiInfo() {
        ApiInfo apiInfo = new ApiInfoBuilder()
                ...
                .contact(new Contact("niceff",
                        "https://edu.bitejiuyeke.com", "2386389757@qq.com"))
                .version("1.0")
                .build();
        return apiInfo;
    }
